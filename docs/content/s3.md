...
{{< provider name="FPT Smart Cloud" home="https://fptcloud.com/" config="/s3/#fptsmartcloud" >}}
...
Endpoint for FPT Smart Cloud Object Storage.
...
### FPT Smart Cloud {#fptsmartcloud}

[FPT Smart Cloud Object Storage (FOS)](https://fos.fptcloud.com) is a distributed storage service offered by FPT Smart Cloud for unstructured data. It is secure, stable, massive, convenient, low-delay and low-cost.

To configure access to FPT Smart Cloud FOS, follow the steps below:
...
2. Give the name of the configuration. For example, name it 'fos'.
...
4. Select `FPTSmartCloud` provider.
```
Choose a number from below, or type in your own value
1 / Amazon Web Services (AWS) S3
   \ "AWS"
[snip]
14 / FPT Object Storage
   \ "FPTSmartCloud"
[snip]
provider> FPTSmartCloud
```

5. Enter your SecretId and SecretKey of FPT Smart Cloud.
...
6. Select region for FPT Smart Cloud. 
